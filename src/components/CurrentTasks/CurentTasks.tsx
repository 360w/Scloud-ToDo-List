...
atWorkCounter: number,
isClosedCounter: number
};

export const CurrentTasks:FC<CurrentTasksProps> = ({isOpenCounter, atWorkCounter, isClosedCounter}) => {
    return (
...
<p className='tasksContainer__text'>Открыто - {isOpenCounter}</p>
</div>
...
<p className='tasksContainer__text'>В работе - {atWorkCounter}</p>
                </div>
...
<p className='tasksContainer__text'>Закрыто - {isClosedCounter}</p>
                </div>
            </div>
        </div>
    )
